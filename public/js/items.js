...
var app = angular.module('items', ['ngTable', 'ngResource', 'ngRoute']).controller('DemoListCtrl', function ($scope, $location, $resource, $routeParams, ngTableParams) {
    ...
    $routeProvider.when('/items/:type/list', { templateUrl: '../partials/item-list.html', controller: 'DemoListCtrl' }).when('/items/:type/:id', { templateUrl: '../partials/item-detail.html', controller: 'DemoDetailCtrl' }).when('/images/:type/list', { templateUrl: '../partials/image-list.html', controller: 'DemoListCtrl' }).when('/images/:type/:id', { templateUrl: '../partials/image-detail.html', controller: 'DemoDetailCtrl' }).otherwise({ redirectTo: '/items/list' });
